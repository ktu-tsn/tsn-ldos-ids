...
dataNormal, labelsNormal, normal_count_zeros, normal_count_ones = data_handling.data_proccessing(ns_full_path)        
...
for attack_sce in os.listdir(os.path.abspath(attack_scenarios_path)):
    ...
    dataAttack, labelsAttack, attack_count_zeros, attack_count_ones = data_handling.data_proccessing(attack_sce_path)
    ...
    #After applying feature extraction add the data to the ML_dataset folder  
    data_handling.write_output(dataNormal, labelsNormal, os.path.join(ml_ds_path, attack_sce))
